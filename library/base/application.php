<?php
if (! class_exists ( 'bv39v_application' )) :
	require dirname ( __FILE__ ) . '/base.php';
	class bv39v_application extends bv39v_base {
		...
		public function &sqlite() {
			return $this->cache ( 'bv39v_data_sqlite' );
		}
		public function &request() {
			return $this->cache ( 'bv39v_request' );
		}
		public function &data($data = null) {
			return $this->cache ( $this->classes->data, $data );
		}
		public function &help($tag) {
			return $this->cache ( 'bv39v_data_help', $tag );
		}
		...
		public function __construct($filename) {
			...
			if (! class_exists ( 'bv39v_data_settings' )) {
				$dir = dirname ( $filename );
				require_once $dir . '/library/base/data/settings.php';
				$this->_config = bv39v_data_settings::config ( $filename );
			}
		...
		public function &loader() {
			return $this->cache ( 'bv39v_loader' );
		}
	}
endif;