<?php
class bv19v_loader extends bv19v_base {
	...
	public function load_class($class, $dirs = null) {
		...
		$file = str_replace ( 'av19v', 'library/api', $file);
		$file = str_replace ( 'bv19v', 'library/base', $file );
		$file = str_replace ( 'sv19v', 'library/survey', $file);
		$file = str_replace ( 'wv19v', 'library/wordpress', $file);
