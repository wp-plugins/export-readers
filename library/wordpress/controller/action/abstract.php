<?php
abstract class wv19v_controller_action_abstract extends bv19v_controller_action {
	...
	protected function set_view() {
		$this->view = new wv19v_view ( $this->application () );
	}
	...
	protected function subpages() {
		...
		foreach ( ( array ) $_GET as $key => $value ) {
			if (bv19v_type_string::staticStartsWith ( $key, 'page' )) {
				$pages [$key] = $value;
			}
		}
		ksort ( $pages );
