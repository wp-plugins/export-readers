<?php
if (! class_exists ( 'wv39v_application' )) :
	require_once dirname ( dirname ( __FILE__ ) ) . DIRECTORY_SEPARATOR . 'base/application.php';
	class wv39v_application extends bv39v_application {
		/*********************************************************************
		 * Settings Getter, Setters & unsetters
		 *********************************************************************/
		public function &user($user_id = null) {
			return $this->cache ( 'wv39v_user', $user_id );
		}
		/*********************************************************************
		 * 
		 *********************************************************************/
		...
		public function &info() {
			return $this->cache ( 'wv39v_info' );
		}
		public function &mu() {
			return $this->cache ( 'wv39v_mu' );
		}
		
		public function &posts() {
			return $this->cache ( 'wv39v_posts' );
		}
		public function &blogs() {
			return $this->cache ( 'wv39v_blogs' );
		}
		public function &legacy() {
			return $this->cache ( $this->classes->legacy );
		}
		public function &comments() {
			return $this->cache ( 'wv39v_comments' );
		}
