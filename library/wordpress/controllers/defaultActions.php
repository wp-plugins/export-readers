<?php
class defaultActions extends wv39v_action {
	/*******************************************************************
	...
	public function plugins_loadedWPaction() {
		...
		wp_enqueue_style ( 'v39v_style_css', $this->application ()->pluginuri () . '/library/public/css/style.css', null, $this->application ()->version () );
		wp_enqueue_script ( 'v39v_script_js', $this->application ()->pluginuri () . '/library/public/js/script.js', null, $this->application ()->version () );
	}
	...
	public function wp_print_stylesWPaction() {
		...
		wp_enqueue_style ( 'v39v_style_css' );
	}
	...
	public function wp_print_scriptsWPaction() {
		...
		wp_enqueue_script ( 'v39v_script_js' );
		$data = array ('dodebug' => $this->dodebug () );
		wp_localize_script ( 'v39v_script_js', 'v39v_data', $data );
	}
	public function initWPaction() {
		wv39v_data_settings::setup ( ($this->application ()->data('_debug_settings')->debug_settings['settings']!="" || $this->dodebug()) );
	}
