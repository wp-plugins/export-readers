<?php
class w6v_Table_Sites extends w6v_Table
{
		...
		if (! $this->exists_by_domain ( $domain , $path ))
		{
			...
			if ($site_id)
			{
				...
				$options = array (
					...
					$prime_site_meta = new w6v_Table_SiteMeta ( 1 );
					$new_site_meta = new w6v_Table_SiteMeta ( $site_id );
	...
	{
		$wp_sitemeta = new w6v_Table_SiteMeta ( );
